...
{
    ros::init(argc, argv, "orbslam1_mono");
    ros::start();
    ...
    if(argc != 3)
    {
        cerr << endl << "Usage: rosrun orb_slam orbslam1_mono path_to_vocabulary path_to_settings (absolute or relative to package directory)" << endl;
        ros::shutdown();
        return 1;
    }
